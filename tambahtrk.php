                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $sql = "CALL insertToBooking(?, ?, ?, ?, ?, ?, NOW())";
                            $stmt = $conn->prepare($sql);
                            $stmt->bind_param("siiids", $nik, $id_admin, $id_tiket, $jumlah_tiket, $total_harga, $tanggal_booking);
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="id_admin" name="id_admin" required>
                                    ...
                                    while ($row = $admin_result->fetch_assoc()) {
                                        echo "<option value='" . $row['ID_ADMIN'] . "'>" . $row['NAMA_ADMIN'] . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="id_tiket" name="id_tiket" required>
                                    ...
                                    while ($row = $tiket_result->fetch_assoc()) {
                                        echo "<option value='" . $row['ID_TIKET'] . "'>" . $row['NAMA_TIKET'] . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
